...
{
  echo "<br/><a target=\"_blank\" href=\"./HAL/OverHAL_pubmed_xml.bib\">Exporter les résultats PubMed pour Bib2HAL</a>";
}
if (file_exists("./HAL/OverHAL_pubmed_csv.bib"))
{
  echo "<br/><a target=\"_blank\" href=\"./HAL/OverHAL_pubmed_csv.bib\">Exporter les résultats Pubmed pour Bib2HAL</a>";
}
...
{
  echo "<br/><a target=\"_blank\" href=\"./HAL/OverHAL_pubmed_xml.zip\">Exporter les résultats Pubmed au format TEI</a>";
}
if (file_exists("./HAL/OverHAL_pubmed_fcgi.zip"))
{
  echo "<br/><a target=\"_blank\" href=\"./HAL/OverHAL_pubmed_fcgi.zip\">Exporter les résultats Pubmed au format TEI</a>";
}
if (file_exists("./HAL/OverHAL_dimensions.zip"))
{
  echo "<br/><a target=\"_blank\" href=\"./HAL/OverHAL_dimensions.zip\">Exporter les résultats Dimensions au format TEI</a>";
}
...
echo "<br/>";
  ...
  <table border=1>
  <?php
  echo "<tr><th><font style='color:white;'>_</font></th><th><font style='color:white;'>_</font></th>";
  foreach ($souBib as $key => $subTab)
  {
    $nomSouBib = $souBib[$key]["Maj"];// Name of the bibliographic source
