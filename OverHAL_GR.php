...
<tr>
<th scope="col" style="text-align: left;"><img alt="OverHAL" title="OverHAL" width="250px" src="./img/logo_OverHAL2.jpg"></th>
...
<br/>
<form enctype="multipart/form-data" action="OverHAL_GR_results.php" method="post" accept-charset="UTF-8">
...
<input type="text" id="team" name="team" value="IRSET" size="40" onchange="majReqHAL();"><br/>
<br/>
